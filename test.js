...
console.log('random', mm.random(100));
console.log('random', mm.random(50, 60));
console.log('2D noise', mm.noise(mm.random(1), mm.random(1)));
console.log('3D noise', mm.noise(mm.random(1), mm.random(1), mm.random(1)));
